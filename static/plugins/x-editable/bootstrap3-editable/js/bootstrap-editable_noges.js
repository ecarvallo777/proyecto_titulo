            ...
            toastr.options = {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        document.getElementById(totalEspecialidad).innerHTML = response.totalEspecialidad;
                        document.getElementById("tot_"+response.Mes).innerHTML= response.totalMes;
                        document.getElementById("tot_total").innerHTML = response.totalTotal;
