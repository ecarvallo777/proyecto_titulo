        ...
        datasets: [
            {
                ...
                data: [302, 297, 292, 287, 282, 277, 272, 267]
            },
            {
                label: "Cole",
                ...
                data: [403, 406, 409, 412, 415, 418, 421, 424]
            },
            {
                label: "Otros",
                fillColor: "rgba(100,102,100,0.2)",
                strokeColor: "rgba(100,102,100,1)",
                pointColor: "rgba(100,102,100,1)",
                pointStrokeColor: "#fff",
                pointHighlightFill: "#fff",
                pointHighlightStroke: "rgba(50,200,203,1)",
                data: [303, 306, 309, 312, 315, 318, 321, 324]
            }
        ]
    };
