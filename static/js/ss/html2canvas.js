...
function Print(){
    var namefile = String(document.getElementById("codsirh").innerHTML);
    var datefile = document.getElementsByClassName("fc-toolbar-title");
    console.log(datefile);
    var dateConverted =datefile[0].outerHTML;
    var dateProcessed = dateConverted.replace('<h2 class="fc-toolbar-title">', "");
    dateProcessed = dateProcessed.replace("</h2>", "");
    dateProcessed = dateProcessed.replace("– ","");
    //dateProcessed = dateProcessed.replaceAll(" ","");

    dateProcessed = dateProcessed.replaceAll(" ","-");
    var DropAreaElement= document.querySelector("#main-wrapper");
    var config= {
        useCORS: true,
        ignoreElements: true,
    ...
    html2canvas(DropAreaElement, config).then(canvas => {
        //document.body.appendChild(canvas)
        // Crear un elemento <a>
      let enlace = document.createElement('a');
      // El título
      enlace.download = namefile+'_'+dateProcessed+'.png';
